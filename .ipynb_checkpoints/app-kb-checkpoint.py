...
model_name = st.selectbox("Select Model:", ["Claude 3-Sonnet","Llama2_13B", "Claude2v1"], key="Model")
...
response_type = st.selectbox("Select Output Response Type:", ["Text","JSON", "Markdown","CSV"], key="OutputType")
